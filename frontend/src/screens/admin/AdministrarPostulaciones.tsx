...
export interface ManagedJobSource {
    id?: string | number;
    title?: string;
    titulo?: string;
    org?: string;
...
export interface NormalizedVacancy extends ManagedJobSource {
    id: string | number;
    titulo: string;
    organizacion: string;
    tipo: string;
...
interface ManageApplicationsProps {
    jobs?: ManagedJobSource[];
    onEditJob?: (job: NormalizedVacancy) => void;
}

import "../../styles/admin/postulaciones.css";

/** Preserved local opportunity administration prototype. */
function AdministrarPostulaciones({
    ...
    const vacantes: NormalizedVacancy[] = Array.isArray(jobs)
        ? jobs.map((job, index) => {
    ...
    const handleVer = (item: NormalizedVacancy) => {
    ...
    const handleEditar = (item: NormalizedVacancy) => {
