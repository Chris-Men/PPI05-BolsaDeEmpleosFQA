...
import {
    initialSiteConfiguration as configuracionInicial,
    type SiteConfiguration,
} from '../../config/siteConfiguration';

import "../../styles/admin/configuracion.css";

type ConfigurationSection = keyof SiteConfiguration;

interface ConfigurationProps {
    configuration: SiteConfiguration;
    setConfiguration: import('react').Dispatch<import('react').SetStateAction<SiteConfiguration>>;
...
const normalizarConfiguracion = (configuracion?: SiteConfiguration | null): SiteConfiguration => {

    const base: SiteConfiguration = configuracion ?? configuracionInicial;
...
/** Preserved local site configuration prototype. */
